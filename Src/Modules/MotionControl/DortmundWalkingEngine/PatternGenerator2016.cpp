...
//
//
//  forward = sidestep =currentMovement.speed.translation / curStepDuration;
...
StepData PatternGenerator2016::getNextStep()
{
  ...
  // #endif
  int crouchingLength = wasReady ? theWalkingEngineParams.walkTransition.crouchingDownPhaseLength : 30; // Was ist das f�r ein Hack?!
